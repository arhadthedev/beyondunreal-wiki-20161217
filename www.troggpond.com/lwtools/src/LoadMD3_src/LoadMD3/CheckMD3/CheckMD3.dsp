...
# ADD LINK32 server.lib /nologo /subsystem:console /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libcmtd.lib" /out:"CheckMD3.exe" /libpath:"$(LW_SOURCE)\SDK\lib" /libpath:"..\lib"
# SUBTRACT LINK32 /nodefaultlib
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy CheckMD3.exe  ..\bin
...
# ADD LINK32 server.lib kernel32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libcmt" /out:"CheckMD3.exe" /pdbtype:sept /libpath:"..\lib" /libpath:"$(LW_SOURCE)\SDK\lib"
# SUBTRACT LINK32 /nodefaultlib
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy CheckMD3.exe ..\bin
