...
# ADD LINK32 server.lib kernel32.lib /nologo /subsystem:windows /dll /pdb:none /machine:I386 /nodefaultlib:"libcd" /nodefaultlib:"libc" /out:"MRB_Xhub.p" /implib:"Debug/LayoutRecorder.lib" /libpath:"$(LW_SOURCE)\SDK\lib" /libpath:"..\lib" -export:_mod_descrip
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=Copy
PostBuild_Cmds=copy         MRB_Xhub.p        ..\bin
...
# ADD LINK32 server.lib libcmtd.lib kernel32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"libcd" /nodefaultlib:"libc" /out:"MRB_Xhub.p" /libpath:"..\lib" /libpath:"$(LW_SOURCE)\SDK\lib" -export:_mod_descrip
