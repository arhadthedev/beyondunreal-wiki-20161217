...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(ARMusic_Player)
};

#endif

AUTOGENERATE_FUNCTION(ARMusic_Player,3136,execRMusic_Close);
AUTOGENERATE_FUNCTION(ARMusic_Player,3135,execRMusic_Stop);
AUTOGENERATE_FUNCTION(ARMusic_Player,3134,execRMusic_GetVolume);
AUTOGENERATE_FUNCTION(ARMusic_Player,3133,execRMusic_DecVolume);
AUTOGENERATE_FUNCTION(ARMusic_Player,3132,execRMusic_IncVolume);
AUTOGENERATE_FUNCTION(ARMusic_Player,3131,execRMusic_SetVolume);
AUTOGENERATE_FUNCTION(ARMusic_Player,3130,execRMusic_SetCfgVolume);
AUTOGENERATE_FUNCTION(ARMusic_Player,3129,execRMusic_IsPlaying);
AUTOGENERATE_FUNCTION(ARMusic_Player,3128,execRMusic_Pause);
AUTOGENERATE_FUNCTION(ARMusic_Player,3127,execRMusic_Play);
AUTOGENERATE_FUNCTION(ARMusic_Player,3126,execRMusic_Update);
AUTOGENERATE_FUNCTION(ARMusic_Player,3125,execRMusic_LoadPlugin);
AUTOGENERATE_FUNCTION(ARMusic_Player,3124,execRMusic_Startup);
